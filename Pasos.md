...
```
	#Genero archivos binarios de cada archivo .c
...
```
	#Creo librería dinámica
		gcc -shared add_two.o arrays.o -o libmymath.so
```
...
```
	#Creo archivo en python prueba.py para invocar las fciones de la librería dinámica de C
